...
router.post("/forgot-password", async (req, res) => {
    try {
        ...
        // Maak Ethereal test account (dit genereert automatisch inloggegevens)
        ...
        // Verander port naar Vite port (5173/5174 etc)
...
// Wachtwoord Resetten (Nieuw wachtwoord opslaan)
